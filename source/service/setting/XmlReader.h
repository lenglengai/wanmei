...
namespace std {
	...
	public:
		...
		template<class T>
		void runStreamsCount(list<boost::shared_ptr<T>>& nValue, const char * nNames, const char * nName, __i32 nCount = 0);
		template<class T0, class T1>
		void runKeyStreamsCount(map<T0, boost::shared_ptr<T1>>& nValue, const char * nNames, const char * nName, __i32 nCount = 0);
	...
	private:
		...
		boost::shared_ptr<file<char>> mFileDoc;
	...
	template<class T0>
	void XmlReader::runStreamsCount(list<boost::shared_ptr<T0> >& nValue, const char * nNames, const char * nName, __i32 nCount)
	{
		mXmlNodes.push(mXmlNode);
	...
	template<class T0, class T1>
	void XmlReader::runKeyStreamsCount(map<T0, boost::shared_ptr<T1>>& nValue, const char * nNames, const char * nName, __i32 nCount)
	{
		mXmlNodes.push(mXmlNode);
		xml_node<char> * xmlNode_ = mXmlNode->first_node(nNames);
		xmlNode_ = xmlNode_->first_node();
